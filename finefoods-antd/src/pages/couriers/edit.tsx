        ...
        <Col span={9}>
          <Form {...formProps} layout="horizontal" disabled={isFormDisabled}>
            ...
            >
              <FormItemHorizontal
                isInput={false}
                icon={<RightCircleOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}
              ...
              />
              <FormItemHorizontal
                icon={<ScanOutlined onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />}

...
def task(doc_name, from_doctype, to_doctype):
	from erplite.accounts.doctype.payment_entry import payment_entry
	from erplite.accounts.doctype.purchase_invoice import purchase_invoice
	from erplite.accounts.doctype.sales_invoice import sales_invoice
	from erplite.buying.doctype.purchase_order import purchase_order
	from erplite.buying.doctype.supplier_quotation import supplier_quotation
	from erplite.selling.doctype.quotation import quotation
	from erplite.selling.doctype.sales_order import sales_order
	from erplite.stock.doctype.delivery_note import delivery_note
	from erplite.stock.doctype.purchase_receipt import purchase_receipt

...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from erplite.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
...
def create_pick_list(source_name, target_doc=None):
	from erplite.stock.doctype.packed_item.packed_item import is_product_bundle

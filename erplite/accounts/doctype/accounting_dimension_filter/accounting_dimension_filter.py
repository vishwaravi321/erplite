...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from erplite.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from erplite.accounts.doctype.applicable_on_account.applicable_on_account import (
			ApplicableOnAccount,
		)

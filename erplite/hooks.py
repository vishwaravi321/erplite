...
website_route_rules = [{'from_route': '/nxweb_erp/<path:app_path>', 'to_route': 'nxweb_erp'}, {'from_route': '/frontend/<path:app_path>', 'to_route': 'frontend'}, {'from_route': '/frontend/<path:app_path>', 'to_route': 'frontend'}, {'from_route': '/nxweb_erp/<path:app_path>', 'to_route': 'nxweb_erp'}, {'from_route': '/nxweb_erp/<path:app_path>', 'to_route': 'nxweb_erp'},]
...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from erplite.accounts.doctype.pos_customer_group.pos_customer_group import POSCustomerGroup
		from erplite.accounts.doctype.pos_item_group.pos_item_group import POSItemGroup
		from erplite.accounts.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from erplite.accounts.doctype.pos_profile_user.pos_profile_user import POSProfileUser

...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from erplite.accounts.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from erplite.accounts.doctype.shipping_rule_country.shipping_rule_country import (
			ShippingRuleCountry,
		)

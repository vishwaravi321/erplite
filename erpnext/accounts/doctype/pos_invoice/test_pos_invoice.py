...
class TestPOSInvoice(unittest.TestCase):
	...
	def test_loyalty_points(self):
		...
		from erplite.accounts.doctype.loyalty_program.test_loyalty_program import create_records
	...
	def test_ignore_pricing_rule(self):
		from erplite.accounts.doctype.pricing_rule.test_pricing_rule import make_pricing_rule
	...
	def test_delivered_serial_no_case(self):
		from erplite.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)

...
import erplite
from erplite.accounts.report.balance_sheet.balance_sheet import (
	get_chart_data,
...
from erplite.accounts.report.cash_flow.cash_flow import (
	add_total_row_account,
	get_account_type_based_gl_data,
	get_cash_flow_accounts,
)
from erplite.accounts.report.cash_flow.cash_flow import get_report_summary as get_cash_flow_summary
...
from erplite.accounts.report.utils import convert, convert_to_presentation_currency
...
def get_columns(companies, filters):
	...
	for company in companies:
		...
		if not currency:
			currency = erplite.get_company_currency(company)
			...
			if d:
				...
				for company in companies:
					...
					if (
						...
						parent_company_currency = erplite.get_company_currency(d.company)
						child_company_currency = erplite.get_company_currency(entry.company)

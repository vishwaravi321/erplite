...
from erplite.accounts.party import render_address
from erplite.controllers.accounts_controller import get_taxes_and_charges
...
from erplite.stock.doctype.item.item import set_item_default
from erplite.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			...
			from erplite.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from erplite.controllers.buying_controller import validate_item_type

...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "erplite")
	try:
		...
		capture("demo_data_creation_failed", "erplite", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "erplite")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "erplite")
	try:
...
def make_transactions(company):
	...
	from erplite.accounts.utils import FiscalYearError

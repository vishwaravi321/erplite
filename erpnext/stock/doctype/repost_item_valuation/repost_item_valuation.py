...
import erplite
from erplite.accounts.general_ledger import validate_accounting_period
from erplite.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from erplite.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(erplite.is_perpetual_inventory_enabled(doc.company)):
		return

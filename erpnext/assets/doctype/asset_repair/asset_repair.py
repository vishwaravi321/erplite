...
from erplite.assets.doctype.asset.asset import get_asset_account
...
class AssetRepair(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from erplite.assets.doctype.asset_repair_consumed_item.asset_repair_consumed_item import (
	...
	def get_gl_entries_for_consumed_items(self, gl_entries, fixed_asset_account):
		...
		if not erplite.is_perpetual_inventory_enabled(self.company):
